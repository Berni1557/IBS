...
from helper.YAML import YAML
import h5py
import numpy as np
from datetime import datetime
from collections import defaultdict
from basemodel.DataframeBaseModel import DataframeBaseModel
from helper.helper import splitFolderPath, splitFilePath
# !!! visualizer
from visualizer.TensorboardViewerTorch import TensorboardViewerTorch
from xgboost import XGBClassifier
from helper.SaveState import SaveState
import torch 
...
class DLBaseModel():
    ...
    def loadModel(self, modelfolderpath=None, epoch=None, optimizer=None, scheduler=None, params_train=None, load_model=True, name='unet', strict=True):
                    ...
                    for key in self.model:
                        ...
                        if os.path.exists(modelpath_m):
                            ...
                            if isinstance(self.model[key], XGBClassifier):
                                ...
                                self.model[key].load_state_dict(torch.load(modelpath_m), strict=strict)
                        else:
