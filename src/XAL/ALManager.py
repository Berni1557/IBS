...
import pandas as pd
from XAL.ALSample import ALSample, ALSampleMulti
...
class ALManager:
    ...
    def createALFolderpath(self, fp_active=None, fip_split=None, fp_images=None, fp_references_org=None, method=None, NewVersion=False, VersionUse=None):
        ...
        folderDict=dict()
        # Create fp_active
        print('fp_active123', fp_active, os.path.isdir(fp_active))
        ...
        #print('copy_init123', folderDict['copy_init'], fp_init01, fp_method01)
