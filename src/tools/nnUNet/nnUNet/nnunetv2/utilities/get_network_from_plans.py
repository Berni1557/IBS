...
def get_network_from_plans(arch_class_name, arch_kwargs, arch_kwargs_req_import, input_channels, output_channels,
    ...
    #architecture_kwargs['dropout_op'] = torch.nn.Dropout
    #architecture_kwargs['dropout_op_kwargs'] = {'p':0.1}
    #print('nw_class123', nw_class)
    #print('architecture_kwargs123', architecture_kwargs)
    #sys.exit('EXITX')
